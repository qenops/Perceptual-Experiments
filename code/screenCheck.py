...
for monitor in config.monitors:
    ...
    stim = visual.TextStim(win=win,font='Snellen', height=10, pos=[0,0], text='%s'%monitor.screen, flipHoriz=monitor.flipHoriz) # may want to set fontFiles to include our ennumbered version of snellen (once it is complete)
